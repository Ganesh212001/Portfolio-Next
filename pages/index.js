    ...
    <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
      <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
        ...
        <motion.p variants={fadeIn("down", 0.3)}
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit obcaecati quam eius, voluptas saepe architecto accusamus ipsum eos tempore adipisci eaque vero repudiandae quas beatae!
        </motion.p>
        {/* Btn */}
